...
void changeLabel2(GtkWidget *button, gpointer data[10]) {
	// I struggled with passing structs through a get widget callback
	// so I used a global struct instead of passing it through "gpointer"
	// data is merely an array of label "objects"
	/**\
	 *
	 * 	char beadType[40];
	char decadeName[800];
...
* */
	...
	gtk_label_set_text(data[0], "Changed Label Text 1");
	gtk_label_set_text(data[1], "Changed Label Text 1");
	gtk_label_set_text(data[2], "Changed Label Text 2");
	gtk_label_set_text(data[3], "Changed Label Text 3");
	gtk_label_set_text(data[4], "Changed Label Text 4");
